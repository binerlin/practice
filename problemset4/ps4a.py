...
def loadWords():
	...
	# inFile: file
	with open(WORDLIST_FILENAME, 'r') as line:
		wordList = line.read().lower()
...
def playHand(hand, wordList, n):
	...
	* The hand finishes when there are no more unused letters or the user
	...
	word = ''
	score = 0
	dishand = displayHand(hand)
	curhand = copy.copy(hand)
		
	# As long as there are still letters left in the hand:
	while calculateHandlen(curhand) > 0:
		# Display the hand
		print('Current Hand:  %s' % dishand)
		# Ask user for input
